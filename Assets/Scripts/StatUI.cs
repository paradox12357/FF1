        ...
        while (true)
        {
            if (Input.GetKeyDown("a") || Input.GetKeyDown("s"))
            {
                if (car == 2)
                {
                    ...
                    while (Car3.position.x < offScreen.position.x)
                    {
                    ...
                    while (Car2.position.x > onScreen.position.x)
                    {
                        Car2.transform.Translate(Vector3.left * speed * Time.deltaTime);
                        yield return null;
                    }
                }
                else if (car == 1)
                {
                    ...
                    while (Car2.position.x < offScreen.position.x)
                    {
                    ...
                    while (Car1.position.x > onScreen.position.x)
                    {
                        Car1.transform.Translate(Vector3.left * speed * Time.deltaTime);
                        yield return null;
                    }
                }
            ...
            if (Input.GetKeyDown("w") || Input.GetKeyDown("d"))
            {
                if (car == 0)
                {
                    ...
                    while (Car1.position.x < offScreen.position.x)
                    {
                ...
                else if (car == 1)
                {
                    ...
                    while (Car3.position.x > onScreen.position.x)
                    {
                        Car3.transform.Translate(Vector3.left * speed * Time.deltaTime);
                        yield return null;
                    }
                }
